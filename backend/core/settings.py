...
DATABASES = {
    'default': {
        ...
        'NAME': os.environ.get('DB_NAME', 'gestao_energia'),
        'USER': os.environ.get('DB_USER', 'admin'),
        'PASSWORD': os.environ.get('DB_PASSWORD', 'senha_segura_iot'),
        'HOST': 'db',  # Nome do serviço no seu docker-compose.yml
        'PORT': '5432',
    }
}
...
SIMPLE_JWT = {
    'ACCESS_TOKEN_LIFETIME': timedelta(hours=24), # Token vale por 1 dia
